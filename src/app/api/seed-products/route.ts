  ...
  try {
    ...
    const products = [
      ...
      // EXHAUSTS CATEGORY
      {
        ...
        reviews: 89,
        description:
          "High-performance exhaust system that enhances engine sound and performance.",
        features: [
          "Stainless steel",
          "Performance boost",
          "Deep sound",
      ...
      },
      {
        ...
        reviews: 67,
        description:
          "Sport muffler that provides aggressive sound and improved airflow.",
        features: [
          "Aggressive sound",
          "Improved airflow",
          "Lightweight",
      ...
      {
        id: "exhaust-3",
        name: "Dual Exhaust Tips",
        title: "Dual Exhaust Tips",
        category: "exhausts",
        price: 89.99,
        ...
        reviews: 42,
        description:
          "Stylish dual exhaust tips that enhance the look of your vehicle.",
        features: [
          "Dual design",
          "Stainless steel",
          "Easy install",
      ...
      },
      {
        ...
        reviews: 23,
        description:
          "Premium carbon fiber exhaust system for ultimate performance and style.",
        features: [
          "Carbon fiber",
          "Ultra lightweight",
          "Premium sound",
