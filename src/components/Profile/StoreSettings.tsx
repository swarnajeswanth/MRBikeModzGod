...
const StoreSettings = () => {
  ...
  const getFeatureIcon = (feature: string, enabled: boolean) => {
    const iconMap: { [key: string]: { enabled: any; disabled: any } } = {
      ...
      bikeCompatibility: { enabled: Settings, disabled: X },
      installationGuides: { enabled: FileText, disabled: FileX },
      warrantyInfo: { enabled: Shield, disabled: X },
      returnPolicy: { enabled: RotateCcw, disabled: X },
      bulkOrdering: { enabled: Package, disabled: X },
      customModifications: { enabled: Wrench, disabled: X },
      performanceMetrics: { enabled: Zap, disabled: ZapOff },
      brandFiltering: { enabled: Filter, disabled: Slash },
      priceAlerts: { enabled: Bell, disabled: BellOff },
      stockNotifications: { enabled: Bell, disabled: BellOff },
      comparisonTool: { enabled: Grid, disabled: Square },
      fitmentGuides: { enabled: FileText, disabled: FileX },
      maintenanceSchedules: { enabled: Calendar, disabled: X },
      partCompatibility: { enabled: Settings, disabled: X },
    };
  ...
  const getPageIcon = (page: string, enabled: boolean) => {
    const iconMap: { [key: string]: { enabled: any; disabled: any } } = {
      ...
      maintenanceSchedules: { enabled: Calendar, disabled: X },
      partCompatibility: { enabled: Settings, disabled: X },
      dealerLocator: { enabled: MapPin, disabled: X },
      serviceCenters: { enabled: Wrench, disabled: X },
      trainingVideos: { enabled: Play, disabled: Pause },
      blog: { enabled: FileText, disabled: FileX },
      support: { enabled: MessageCircle, disabled: X },
    };
  ...
  const getCustomerExperienceIcon = (setting: string, enabled: boolean) => {
    const iconMap: { [key: string]: { enabled: any; disabled: any } } = {
      ...
      showInstallationGuides: { enabled: FileText, disabled: FileX },
      showWarrantyInfo: { enabled: Shield, disabled: X },
      showReturnPolicy: { enabled: RotateCcw, disabled: X },
      allowBulkOrdering: { enabled: Package, disabled: X },
      allowCustomModifications: { enabled: Wrench, disabled: X },
      showPerformanceMetrics: { enabled: Zap, disabled: ZapOff },
      enableBrandFiltering: { enabled: Filter, disabled: Slash },
      enablePriceAlerts: { enabled: Bell, disabled: BellOff },
      enableStockNotifications: { enabled: Bell, disabled: BellOff },
      enableComparisonTool: { enabled: Grid, disabled: Square },
      showFitmentGuides: { enabled: FileText, disabled: FileX },
      showMaintenanceSchedules: { enabled: Calendar, disabled: X },
      showPartCompatibility: { enabled: Settings, disabled: X },
      enableDealerLocator: { enabled: MapPin, disabled: X },
      enableServiceCenters: { enabled: Wrench, disabled: X },
      showTrainingVideos: { enabled: Play, disabled: Pause },
      enableBlog: { enabled: FileText, disabled: FileX },
      enableSupport: { enabled: MessageCircle, disabled: X },
      requireVINVerification: { enabled: Shield, disabled: X },
      showBikeCompatibility: { enabled: Settings, disabled: X },
      enableExpertConsultation: { enabled: User, disabled: X },
    };
  ...
  const getFeatureDescription = (feature: string) => {
    const descriptions: { [key: string]: string } = {
      ...
      bikeCompatibility: "Show bike compatibility information",
      installationGuides: "Provide installation guides for parts",
      warrantyInfo: "Display warranty information for products",
      returnPolicy: "Show return policy information",
      bulkOrdering: "Allow bulk ordering for dealers",
      customModifications: "Enable custom part modifications",
      performanceMetrics: "Show performance data for parts",
      brandFiltering: "Allow filtering by bike brands",
      priceAlerts: "Enable price drop notifications",
      stockNotifications: "Notify when items come back in stock",
      comparisonTool: "Allow comparing multiple products",
      fitmentGuides: "Provide fitment guides for parts",
      maintenanceSchedules: "Show maintenance schedules",
      partCompatibility: "Display part compatibility information",
    };
  ...
  const getPageDescription = (page: string) => {
    const descriptions: { [key: string]: string } = {
      ...
      installationGuides: "Installation guides and tutorials",
      warrantyInfo: "Warranty information and policies",
      returnPolicy: "Return and refund policies",
      bulkOrdering: "Bulk ordering for dealers",
      customModifications: "Custom part modifications",
      performanceMetrics: "Performance data and metrics",
      comparisonTool: "Product comparison tool",
      fitmentGuides: "Part fitment guides",
      maintenanceSchedules: "Maintenance schedules",
      partCompatibility: "Part compatibility checker",
      dealerLocator: "Find authorized dealers",
      serviceCenters: "Service center locations",
      trainingVideos: "Training and tutorial videos",
  ...
  const getCustomerExperienceDescription = (setting: string) => {
    const descriptions: { [key: string]: string } = {
      ...
      showInstallationGuides: "Show installation guides to customers",
      showWarrantyInfo: "Display warranty information",
      showReturnPolicy: "Show return policy details",
      allowBulkOrdering: "Allow bulk ordering for dealers",
      allowCustomModifications: "Enable custom modifications",
      showPerformanceMetrics: "Display performance data",
      enableBrandFiltering: "Enable filtering by bike brands",
      enablePriceAlerts: "Send price drop alerts",
      enableStockNotifications: "Notify when items restock",
      enableComparisonTool: "Enable product comparison",
      showFitmentGuides: "Show fitment guides",
      showMaintenanceSchedules: "Display maintenance schedules",
      showPartCompatibility: "Show compatibility information",
      enableDealerLocator: "Enable dealer locator",
      enableServiceCenters: "Show service center locations",
      showTrainingVideos: "Display training videos",
      enableBlog: "Enable blog and articles",
      enableSupport: "Enable customer support",
      requireVINVerification: "Require VIN for compatibility",
      showBikeCompatibility: "Show bike compatibility info",
      enableExpertConsultation: "Enable expert consultation",
    };
