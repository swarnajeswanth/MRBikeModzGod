  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 p-6 rounded-lg mt-6">
        ...
        {/* Navigation Tabs */}
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 p-2 rounded-lg mt-6">
        ...
        {activeTab === "slider" && (
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 p-6 rounded-lg mt-6">
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      if (result.success) {
                        toast.success(
                          "Default slider images added successfully"
                        );
                        window.location.reload();
                      } else {
            ...
            <p className="text-gray-400">
              Upload, edit, and manage the images displayed in the hero slider
              on your homepage.
            </p>
          </div>
        )}
